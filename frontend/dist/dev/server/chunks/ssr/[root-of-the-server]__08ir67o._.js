...
function normalizeSiteData(input) {
    const source = input ?? {};
    const authorProfileBlocks = Array.isArray(source.authorProfile?.blocks) ? source.authorProfile.blocks : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultSiteData"].authorProfile.blocks;
    const mainPageBlocks = Array.isArray(source.mainPage?.blocks) ? source.mainPage.blocks.filter((block)=>block.content !== '환영합니다' && !block.content.includes('작가 포트폴리오 사이트입니다')) : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultSiteData"].mainPage.blocks;
    return {
        authorProfile: {
            blocks: authorProfileBlocks,
            updatedAt: source.authorProfile?.updatedAt ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultSiteData"].authorProfile.updatedAt
        },
        works: Array.isArray(source.works) ? source.works : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultSiteData"].works,
        activities: Array.isArray(source.activities) ? source.activities : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultSiteData"].activities,
        mainPage: {
            banners: Array.isArray(source.mainPage?.banners) ? source.mainPage.banners : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultSiteData"].mainPage.banners,
            blocks: mainPageBlocks,
            updatedAt: source.mainPage?.updatedAt ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defaultSiteData"].mainPage.updatedAt
        }
    };
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08ir67o._.js.map